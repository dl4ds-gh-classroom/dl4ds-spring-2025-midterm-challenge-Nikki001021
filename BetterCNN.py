...
################################################################################
# For Part 2, I am using a predefined model from torchvision called ResNet18
# ###############################################################################
...
def main():
    ...
    CONFIG = {
        "model": "BetterCNN",   # Change name when using a different model
    ...
    ############################################################################
    model = ResNet18_model()   # instantiate your model ### TODO
    ...
    scheduler = optim.lr_scheduler.StepLR(optimizer, step_size=2, gamma=0.5)  # Add a scheduler   ### TODO -- you can optionally add a LR scheduler
    ...
    # --- Evaluation on OOD ---
    all_predictions = eval_ood2.evaluate_ood_test(model, CONFIG)

    # --- Create Submission File (OOD) ---
    submission_df_ood = eval_ood2.create_ood_df(all_predictions)
